module _35_Anything_CS_can_do
// A whirlwind tour of object-oriented code in F#

// As should be apparent, you should generally try to prefer functional-style code over 
// object-oriented code in F#, but in some situations, you may need all the features of a 
// fully fledged OO language — classes, inheritance, virtual methods, etc.
// So just to conclude this section, here is a whirlwind tour of the F# versions of these 
// features.
// Some of these will be dealt with in much more depth in a later series on .NET 
// integration. But I won't cover some of the more obscure ones, as you can read about 
// them in the MSDN documentation if you ever need them.

// Classes and interfaces
// First, here are some examples of an interface, an abstract class, and a concrete class 
...
// Structs
// F# supports not just classes, but the .NET struct types as well, which can help to 
// boost performance in certain cases.
