module _17_Convenience

// Features that reduce programming drudgery and boilerplate code
// - Useful “out-of-the-box” behavior for types. Most types that you create will immediately 
//   have some useful behavior, such as immutability and built-in equality — functionality 
//   that has to be explicitly coded for in C#.
